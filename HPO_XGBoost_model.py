...
def objective(trial):
    ...
    unique_loc = ['Bodegraven','Dordrecht','Middelharnis']
    unique_trans = [' TR1',' TR2','TR1','TR2','TR3','TR4','TR5','TR6','TR7','TR8','TR9','TR10']
    unique_spanning = ['50-10','50-13','150-50']
    scores = []
    for loc in unique_loc:
        for span in unique_spanning:
    ...
    if len(study.trials) != 1:
        if np.mean(scores) < study.best_value:
...
if __name__ == '__main__':
    ...
    study_name = "xgboost_study_v35"  # Unique identifier of the study.
